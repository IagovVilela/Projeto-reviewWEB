...
return [
    ...
    | pela classe de validação. Algumas dessas regras têm múltiplas versões, como
    ...
    */
    ...
    | a convenção "attribute.rule" para nomear as linhas. Isso facilita a especificação
    | de uma linha de idioma personalizada específica para uma determinada regra de atributo.
    |
    */
